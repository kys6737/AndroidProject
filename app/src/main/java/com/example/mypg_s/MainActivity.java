...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("myInfo");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    String firebaseSchoolNum = String.valueOf(dataSnapshot.child("schoolNum").getValue());
                    String firebaseSchool = dataSnapshot.child("school").getValue(String.class);
                    String firebaseStatus = dataSnapshot.child("status").getValue(String.class);
        ...
        editCompleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("email").setValue(editedMail);
            }
        });
    ...
    public void showImgSelectDialog(){
        ...
        defaultImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("profileImageUrl").setValue(defaultImageUrl);
