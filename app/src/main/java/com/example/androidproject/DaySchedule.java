...
public class DaySchedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn0900.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn0900Clicked = (btn0900Clicked==0)? 1:0;
                updateButtonBackground(btn0900, btn0900Clicked);
            }
        });
        ...
        btn0930.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn0930Clicked = (btn0930Clicked==0)? 1:0;
                updateButtonBackground(btn0930, btn0930Clicked);
            }
        });
        ...
        btn1000.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                btn1000Clicked = (btn1000Clicked==0)? 1:0;
                updateButtonBackground(btn1000, btn1000Clicked);
            }
        });
        btn1030.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn1030Clicked = (btn1030Clicked==0)? 1:0;
                updateButtonBackground(btn1030, btn1030Clicked);
            }
        });
        btn1100.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn1100Clicked = (btn1100Clicked==0)? 1:0;
        ...
        btn1130.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn1130Clicked = (btn1130Clicked==0)? 1:0;
        ...
        btn1200.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn1200Clicked = (btn1200Clicked==0)? 1:0;
        ...
        btn1230.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn1230Clicked = (btn1230Clicked==0)? 1:0;
        ...
        btn1300.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btn1300Clicked = (btn1300Clicked==0)? 1:0;
                updateButtonBackground(btn1300, btn1300Clicked);
            }
        });
    ...
    private void ResetBtn(){
        ...
        btn1700Clicked = 1;
        btn1730Clicked = 1;
        updateButtonBackground(btn0900, 1);
        updateButtonBackground(btn0930, 1);
        updateButtonBackground(btn1000, 1);
        updateButtonBackground(btn1030, 1);
        updateButtonBackground(btn1100, 1);
        updateButtonBackground(btn1130, 1);
        updateButtonBackground(btn1200, 1);
        updateButtonBackground(btn1230, 1);
        updateButtonBackground(btn1300, 1);
        updateButtonBackground(btn1330, 1);
        updateButtonBackground(btn1400, 1);
        updateButtonBackground(btn1430, 1);
        updateButtonBackground(btn1500, 1);
        updateButtonBackground(btn1530, 1);
        updateButtonBackground(btn1600, 1);
        updateButtonBackground(btn1630, 1);
        updateButtonBackground(btn1700, 1);
        updateButtonBackground(btn1730, 1);
    }
    ...
    private void updateButtonBackground(Button button, int isClicked) {
        ...
        if (isClicked==0) {
            newBackground = getResources().getDrawable(R.drawable.clickedtimebutton);
        } else {
