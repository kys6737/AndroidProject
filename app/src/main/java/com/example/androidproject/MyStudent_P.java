...
public class MyStudent_P extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String getCode=extras.getString("key");
        ...
        databaseReference.child("student_information")
                .orderByChild("private_key")
                .equalTo(getCode)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            String firebaseMail = dataSnapshot.child("Zoom_link").getValue(String.class);
    ...
    private void downloadImageAndSetToImageView(String imageUrl) {
        ...
        storageRef.getBytes(ONE_MEGABYTE)
                ...
                .addOnFailureListener(e -> {
                    // 이미지 다운로드 실패
                    Toast.makeText(MyStudent_P.this, "이미지 다운로드에 실패했습니다.", Toast.LENGTH_SHORT).show();
                });
    }
}